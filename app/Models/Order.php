...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'subtotal','shipping_cost','shipping_method','tax','tax_breakdown','prices_include_tax','total',
    ...
    protected $casts = [
        ...
        'presentment_subtotal'        => 'decimal:4',
        'presentment_shipping_cost'   => 'decimal:4',
        'presentment_tax'             => 'decimal:4',
        'presentment_discount_amount' => 'decimal:4',
