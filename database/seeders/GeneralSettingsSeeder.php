...
class GeneralSettingsSeeder extends Seeder
{
    ...
    {
        $settings = [
            ['key' => 'general.site_name',        'value' => 'klixbd',               'type' => 'text',    'group' => 'general', 'description' => 'Public-facing site name'],
            ['key' => 'general.site_tagline',      'value' => '',                     'type' => 'text',    'group' => 'general', 'description' => 'Short tagline shown in header/footer'],
            ['key' => 'general.admin_email',       'value' => 'admin@klixbd.com',     'type' => 'text',    'group' => 'general', 'description' => 'Default From address for system emails'],
            ['key' => 'general.timezone',          'value' => 'Asia/Dhaka',           'type' => 'text',    'group' => 'general', 'description' => 'Store timezone'],
            ['key' => 'general.currency',          'value' => 'BDT',                  'type' => 'text',    'group' => 'general', 'description' => 'ISO 4217 currency code'],
            ...
            ['key' => 'general.order_prefix',      'value' => 'KLX',                  'type' => 'text',    'group' => 'general', 'description' => 'Prefix prepended to order numbers'],
