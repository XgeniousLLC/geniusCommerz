        ...
        <x-admin.card>
            ...
            <div class="space-y-4">
                <x-admin.form-group>
                    ...
                    <x-admin.input type="text" name="name" id="cat-name"
                ...
                <x-admin.form-group>
                    ...
                    <x-admin.input type="text" name="slug" id="cat-slug"
                ...
                <x-admin.form-group>
                    ...
                    <textarea name="description" rows="3"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-sm">{{ old('description', $category->description) }}</textarea>
                </x-admin.form-group>
