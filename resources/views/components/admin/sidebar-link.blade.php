...
<a href="{{ $href }}" 
   class="{{ $active 
    ...
    @if($icon)
        <svg class="{{ $active ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-3 flex-shrink-0 h-5 w-5 transition-colors duration-200" 
            ...
            @switch($icon)
                ...
                @case('photograph')
                    ...
                    @break
                @case('users')
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 0a4 4 0 11-8-8 4 4 0 018 8z"></path>
                    @break
                @case('shield-check')
